<template>
  <v-sheet class="mb-2">
    <v-toolbar dense floating flat class="transparent elevation-0">
      ...
      <v-text-field hide-details prepend-icon="fa-search" single-line></v-text-field>
    </v-toolbar>

    <v-expansion-panels multiple v-if="toggleAddPOI" v-model="panel" class="c-border-a elevation-4">
      <v-expansion-panel>
        ...
        <v-expansion-panel-content>
          <v-form ref="form" v-model="isValid">
            ...
            <v-btn :disabled="!isValid || !isUserAuthenticated" @click="submitPOI()">Submit</v-btn>
          </v-form>
        </v-expansion-panel-content>
      </v-expansion-panel>
    </v-expansion-panels>
