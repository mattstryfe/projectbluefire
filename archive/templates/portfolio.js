...
export const credentials = [
  ...
  { title: 'Certified Scrum Master', origin: '', date: '2020' },
  { title: 'Security+', origin: 'Comptia', date: '2016' },
  { title: 'ITIL Foundations', origin: '', date: '2015' }
]
...
export const positions = [
  {
    ...
    details:
      '  Cultivated and deployed stakeholder vision from concept to reality < 8 months during pandemic.'
  },
  {
    year: 2019,
    company: 'MAXAR',
    ...
    details:
      'Built and deployed Vue.js & Micronaut App.' +
  ...
  },
  {
    ...
    details:
      '  Built and integrated Leaflet powered interactive map component.' +
  ...
  },
  {
    ...
    details:
      '  Built & Integrated user history, word cloud, summary window, and text comparison tool'
  },
  {
    year: 2012,
    company: 'U.S.A.F.',
    ...
    highlight:
      'Designed and Built various dynamic dashboard using bootstrap, jquery, and SPDesigner.',
    details:
      '  Built & Integrated user history, word cloud, summary window, and text comparison tool.'
  },
  {
    ...
    highlight:
      'Designed, purchased, and built a 1.1M test lab for VTC accreditation.',
